      ...
      <div className="container flex items-center justify-between h-16 md:h-20">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            className="flex items-center gap-2 bg-gradient-gold text-primary-foreground font-heading font-semibold px-5 py-2.5 rounded-lg hover:opacity-90 transition-opacity text-sm shadow-sm"
          >
